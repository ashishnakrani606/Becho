      ...
      {!opentablepage ? (
                ...
                <div className="bg-primary-light dark:bg-white/5 rounded-lg p-2 mb-2 flex items-center justify-between flex-wrap gap-5 mt-5">
                  <div className="flex items-center">
                      ...
                      <Dropdown
                        ...
                        button={
                          <Image
                            src={Dots}
                            alt=""
                            className="w-5 h-5 dark:invert p-1 cursor-pointer rounded-lg hover:bg-black/5 transition-all duration-300"
                          />
                        }
                        dropdownitem={[
                          { title: "Download", link: "/" },
                    ...
                    <div className="flex items-center">
                      ...
                      <Button color={"grey"} name={"Delete Selected"} />
                    </div>
                  </div>
                  ...
                  <table class="xl:w-full lgm:w-[900px] lg:w-full w-[1020px]">
                    <thead>
                      <tr class="text-black/40 dark:text-white/40 border-b text-xs">
                        <th class="font-normal pl-0 p-3 pr-[10px] before:top-0 before:right-0 before:h-full before:absolute relative h-full text-start heading-border flex">
                        ...
                        <th class="font-normal p-3 pr-[10px] before:top-0 before:right-0 before:h-full before:absolute text-start">
                          Delivery method
                        </th>
                      </tr>
                    </thead>
        ...
        <>
          ...
          > 
            ...
            <Dropdown
              className="right-0 left-[unset] py-[5px] px-2 text-xs"
              button={
          ...
          <UnsavedChanges>
            <Button color={"white"} outline={"true"} name={"Discard"}  className={"mr-5 dark:!border-blacklight dark:!text-blacklight"} />
          ...
          />
          <div className="flex justify-between md:flex-row flex-col items-start xl:mx-9 xl:mt-9 mt-6 gap-y-8">
            <div className="bg-primary-light dark:bg-white/5 md:p-6 p-3 rounded-2xl w-full md:max-w-[52%]">
              ...
              <div className="bg-white dark:bg-black/40">
                <table>
                  <tbody>
                    {Fulfilled.map((item, index) => (
                      <tr className="text-blacklight dark:text-white border-b border-black/5 dark:border-white/5" key={index}>
                        <td className="py-[11px] pl-4 pr-2 max-w-[4%] w-full">
                          <Image src={item.productimg} className="w-full min-w-[24px]" />
                        </td>
                        <td className="py-[11px] max-w-[41%] w-full text-xs leading-[18px] font-normal">
                          {item.product}
                        </td>
                        <td className="py-[11px] px-4 max-w-[9%] w-full text-xs leading-[18px] font-normal">
                          {item.productitem}
                        </td>
                        <td className="py-[11px] pr-4 max-w-[13%] w-full text-xs leading-[18px] font-normal">
                          {item.price}
                        </td>
                ...
                <div className="flex justify-end w-full py-4 pr-7 border-b border-black/10 dark:border-white/10">
                  <Button color={"blackoutline"} name={"Hold fulfillment"} className="mr-5 text-sm dark:text-white" />
                  <Button color={"green"} name={"Fulfill items"} className="text-sm" />
                </div>
              </div>
                    ...
                    <tr className="text-blacklight dark:text-white border-b border-black/5 dark:border-white/5 w-full">
                      ...
                      <td className="font-normal text-xs leading-[18px] text-green2 max-w-[33.33%] w-full py-[11px] px-4">
                        <Link className="flex" href={"/"}>
                          Show tax details <Image src={TexDetail} className="ml-[5px]" />
                        </Link>
                      </td>
                      <td className="font-normal text-xs leading-[18px] max-w-[33.33%] w-full py-[11px] text-right pr-4">
                        ₹183.58
              ...
              <div className="bg-white dark:bg-black/40">
                ...
                <div className="py-4 flex justify-end border-b items-center border-black/10 dark:border-white/10">
                  <Button color={"blackoutline"} name={"Send invoice"} className="mr-4 text-sm dark:text-white" />
                  <Dropdown
                    className="right-0 left-[unset] pr-7"
                    button={
                      <div className="flex gap-2 items-center justify-end py-2 lg:pl-4 lg:pr-5 px-2 text-sm lg:text-lg font-semibold transition-all duration-500 rounded-lg text-white bg-green2">
                        Collect payment
                        <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            fill-rule="evenodd"
            ...
            <div className="bg-primary-light dark:bg-white/5 py-5 pl-4 pr-6 rounded-2xl w-full md:max-w-[46%]">
              <div className="bg-primary-purple/50 dark:bg-black/40 flex items-start p-4 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm leading-[18px] text-black/40 dark:text-white/40">Sample note from customer during checkout.</p>
                </div>
              </div>
              <div>
                <div className="flex justify-between my-[15px] items-center gap-2">
                  ...
                  <Button color={"black10"} name={"Remove Customer"} className="!py-2 px-[12px]" />
                </div>
                <div>
                  <div className="flex w-full mb-4">
                    <p className="text-black/40 dark:text-white/40 text-xs leading-[18px] font-normal max-w-[44%] w-full">Name</p>
                    <p className="text-blacklight dark:text-white text-xs leading-[18px] font-normal">Baalkrishan Lal Sani</p>
                  </div>
                  <div className="flex mb-4 w-full">
                    <p className="text-black/40 dark:text-white/40 text-xs leading-[18px] font-normal max-w-[44%] w-full">Phone</p>
                    <p className="text-blacklight dark:text-white text-xs leading-[18px] font-normal ">
                      No phone provided <Button color={"blackoutline"} name={"Add phone"} className="ml-2 dark:text-white dark:border-white/20" />
                    </p>
                  </div>
                  <div className="flex mb-4 w-full">
                    <p className="text-black/40 dark:text-white/40 text-xs leading-[18px] font-normal max-w-[44%] w-full">Email</p>
                    <p className="text-blacklight dark:text-white text-xs leading-[18px] font-normal ">
                      No email provided <Button color={"blackoutline"} name={"Add email"} className="ml-2 dark:text-white" />
                    </p>
                  </div>
                  <div className="flex w-full">
                    <p className="text-black/40 dark:text-white/40 text-xs leading-[18px] font-normal max-w-[44%] w-full">Address</p>
                    <div className="text-blacklight dark:text-white text-xs leading-[18px] font-normal max-w-[45%] w-full flex items-center">
                      <p>
                      ...
                      <Button color={"blackoutline"} name={"Edit"} className="ml-2 dark:text-white" />
                    </div>
                  </div>
                </div>
              </div>
