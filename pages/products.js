...
import ArchiveSelectTable from "../src/components/products/ArchiveSelectTable";
      ...
      {!opentablepage ? (
        ...
        <>
          ...
          <PageHeader
            ...
            Badgesdata={[{ color: "green", name: "Active" }, { color: "purple", name: "Draft" }]}
          >
            <Link href={'#0'} className="hover:bg-black/20 hover:dark:bg-white/20 text-black/40 dark:text-white/40 text-xs rounded-lg px-2 py-[5px] hover:text-black/80">Duplicate</Link>
            <Link href={"#0"} className=" hover:bg-black/20 hover:dark:bg-white/20 text-black/40 dark:text-white/40 text-xs rounded-lg px-2 py-[5px] hover:text-black/80">
              Preview
            </Link>
            <Link href={"#0"} className="hover:bg-black/20 hover:dark:bg-white/20 text-black/40 dark:text-white/40 text-xs rounded-lg px-2 py-[5px] hover:text-black/80">
              Copy Link
          ...
          <div className="flex flex-wrap justify-between gap-y-5 mb-4">
            <div className="w-full md:max-w-[63%] max-w-[100%] bg-primary-light dark:bg-white/5 rounded-2xl lg:pt-4 lg:pb-5 lg:px-6 p-5 sm:px-5 px-3">
              ...
              <InputContent title={"Description"}>
                <textarea rows="5" className="w-full dark:bg-transparent" value={"Antique wooden chest of drawers"}></textarea>
              </InputContent>
              ...
              <div className="grid">
                ...
                <div className="flex justify-between sm:py-9 py-5 pt-7 flex-wrap gap-4 ">
                  <div>
                    <Button name={"Archive product"} size={"medium"} className="mr-3 mt-2" outline={'true'} color="grey" />
              ...
              <div className="bg-primary-light dark:bg-white/5 rounded-2xl lg:pt-4 lg:pb-5 lg:px-6 sm:p-5 py-5 px-3">
                ...
                <div>
                  ...
                  <InputContent title={"Description"} className={"mb-0"}>
                    <input type="text" name="" value="Antique wooden chest of drawers" className="w-full dark:!bg-transparent"/>
                  </InputContent>
