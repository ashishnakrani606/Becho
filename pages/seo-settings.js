      ...
      <div className="bg-primary-light dark:bg-white/5 rounded-2xl p-4 md:p-6">
        ...
        <div className="px-5 py-4 bg-white dark:bg-black/40 rounded-2xl mb-4 border border-black/10 dark:border-white/10 max-w-[520px] w-full">
          <lable className="text-black/40 dark:text-white/40 text-xs leading-[18px] pb-1">
            Page title: <span className="font-bold">70</span> characters recommended.
          </lable>          
          <p contentEditable="true" className="text-blacklight dark:text-white text-sm	outline-none">The title of your store’s homepage</p>
        </div>
        <div className="px-5 py-4 bg-white dark:bg-black/40 rounded-2xl mb-4 border border-black/10 dark:border-white/10 max-w-[520px] w-full">
          <lable className="text-black/40 dark:text-white/40 text-xs leading-[18px] pb-1">
          Meta description: <span className="font-bold">156</span> characters recommended.
          </lable>
          <p contentEditable="true" className="text-blacklight dark:text-white text-sm outline-none">Used in meta data and search results</p>
        </div>          
        <SetupUpdate
