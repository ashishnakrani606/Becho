    ...
    <Layout container>
                ...
                <table className="w-[640px] lg:w-[600px] md:w-[590px] xl:w-full sm:w-full">
                  <thead>
                    <tr className="border-b border-black/5 dark:border-white/5">
                      <th className="text-left pl-4 py-3">Type</th>
                      <th className="text-left pl-4 py-3">Details</th>
                      <th className="text-left pl-4 py-3">Amount</th>
                      <th className="text-left pl-4 py-3">GST (18%)</th>
                      <th className="text-left pl-4 py-3">Total Amount</th>
                    </tr>
                  </thead>
                  <tbody>
                    {invoiceDetails.map((item, index) => (
                      <tr
                        ...
                        key={index}
                      >
                        <td className="py-2 pl-4 text-xs leading-[18px] font-normal whitespace-nowrap">{item.product}</td>
                ...
                <table className="w-[640px] sm:w-full">
                  <tbody className="w-full">
                    ...
                    <tr className="text-blacklight dark:text-white border-b border-black/5 dark:border-white/5 w-full">
                      ...
                      <td className="font-semibold text-sm max-w-[33.33%] w-full py-2.5	pr-4 text-right">₹3,77,600.00</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                  ...
                  {customer.map((item, index) => (
                    <div key={index}>
                      <div className="flex w-full mb-4 flex-wrap sm:flex-nowrap">
                        ...
                        <p className="text-blacklight dark:text-white text-sm leading-[18px] font-medium">
      ...
      <Modal title={"Add Customer"} open={open} setOpen={setOpen}>
        ...
        <div className="py-3 flex justify-end items-center">
          ...
          ></Button>
          <Button color="primarygreen" size="large" className={"ml-4 !px-4 text-sm font-semibold"} name={"Save"}></Button>
        </div>
      </Modal>
    </Layout>
  );
