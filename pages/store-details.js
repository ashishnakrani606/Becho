                ...
                <div className="flex pb-[18px] flex-wrap sm:flex-nowrap">
                  ...
                  <div className="max-w-full w-full flex items-center"> 
                    <input
                      ...
                      readOnly={!openinput}
                      Value={item.data}                      
                      className={`${openinput ? "dark:bg-blacklight bg-white px-3 py-2 rounded-lg border-black/10 border dark:border-white/10" : "bg-transparent" } w-full`}
                    />
                    {
                  ...
                  <div className="w-full items-center grid grid-cols-2 gap-4">
                    <div className={`${openinput ? "dark:bg-blacklight bg-white px-3 py-2 rounded-lg border-black/10 border dark:border-white/10" : "pointer-events-none [&>div>div>button>span:last-child]:!invisible"}`}>
                      <SelectOption 
                        selectitem={[
                          { name: "Pilani" },
                          { name: "Andhra Pradesh" },
                        ...
                        className={`!text-black/80 dark:!text-white/80 ${openinput && "w-full block"}`}
                      />
                    </div>
                    <div className={`${openinput ? "dark:bg-blacklight bg-white px-3 py-2 rounded-lg border-black/10 border dark:border-white/10" : "pointer-events-none [&>div>div>button>span:last-child]:!invisible"}`}> 
                      <SelectOption 
