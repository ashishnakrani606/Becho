...
const TableRow = [
  {
    ...
    buttonOutline: "!text-blacklight dark:!text-white !border-black/10 dark:!border-white/10",
    ...
    <Layout>
        <>
          <div className="flex justify-between items-center text mb-5 flex-wrap gap-5">
            ...
            <div>
              <Button className="py-[5px] sm:px-2 px-[1px] sm:mr-2 text-xs" name={" Export"} secondary={"true"} />
              <Button className="py-[5px] sm:px-2 px-[1px] sm:mr-2 text-xs" secondary={"true"} name={"Import"} />
              <Button color={"green"} name={"Add client"} className="" size={"small"} />
            </div>
            </div>
          <>
            <div className="bg-primary-light dark:bg-white/5 rounded-lg p-2 mb-2 flex items-center justify-between flex-wrap gap-5">
              <div className="flex items-center flex-wrap">
                ...
                <div className="flex items-center">
                  ...
                  <span className="mr-4 text-xs min-w-[67px]">{selected.length} Selected</span>
                  <Button color={"lightgrey"} name={"Delete Selected"} secondary={"true"} className={"!py-1 !text-sm"} />
                </div>
              </div>
              <div className="flex items-center">
              ...
              <table className="xl:w-[1280px] 2xl:w-full lgm:w-[1000px] lg:w-full w-[1020px]">
                <thead>
                  <tr className="text-black/40 dark:text-white/40 border-b text-xs ">
                    ...
                    <th className="font-normal p-3 pr-[10px]  text-start relative h-full heading-border">Agreement</th>
                  </tr>
                </thead>
                <tbody>
                  <ClientTable
                    selectAll={selectAll}
                    handleChange={selectClientItem}
