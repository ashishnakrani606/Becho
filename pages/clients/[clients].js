  ...
  return (
    <Layout container>
      ...
      <PageHeader
        ...
        Badgesdata={[
          { color: "red", name: "In Notice Period - 59 days left" },  
        ]}
        />
      <div className="flex justify-between  flex-wrap gap-y-4">
        <div className="w-full md:max-w-[63%] max-w-[100%] bg-primary-light dark:bg-white/5 rounded-2xl py-4 lg:pl-6 lg:pr-[46px] sm:px-5 px-3">
          <div>
            <InputContent title={"Company name"}>
              <input type="text" name="" defaultValue="Company name" className="bg-transparent w-full" />
            </InputContent>
          ...
          <InputContent title={"Email address"} className="dark:bg-black/40">
              <input type="email" name="" defaultValue="abccompany@gmail.com" className="w-full dark:bg-transparent" />
          </InputContent>
          <div className="grid sm:grid-cols-2 sm:gap-6">
              ...
              <div className="grid sm:grid-cols-2 sm:gap-6 gap-3">
                <div className=" inline-block min-h-[1.5rem]">
                  <div
                    ...
                    className={`cursor-pointer bg-white dark:bg-black/40 dark:border-white/10 border border-black/10 rounded-lg py-6 px-5 relative ${
                ...
                <div className=" inline-block min-h-[1.5rem]">
                  <div
                    ...
                    className={`cursor-pointer bg-white dark:bg-black/40  border border-black/10 rounded-lg py-6 px-5 relative ${
          ...
          <InputContent title={"Address"}>
              <input type="text" name="" defaultValue="Exploit Cross-Platform Mindshare 52, Ekbal Society, ShwetaPur Pilani" className="bg-transparent w-full" />
            </InputContent>
          <InputContent title={"Apartment etc."}>
              <input type="text" name="" defaultValue="Apartment, suite, etc" className="bg-transparent w-full" />
            </InputContent>
            <div className="grid sm:grid-cols-2 sm:gap-6">
          ...
          <div className="grid sm:grid-cols-2 sm:gap-6">
            <InputContent title={"Country code"} className="dark:bg-black/40 sm:mb-0">
              <VarientDropdown
                selectitem={[
                  { name: "+91" },
                  { name: "Algeria (+213)" },
            ...
            <InputContent title={"Phone number"} className="dark:bg-black/40 sm:mb-0">
              <input type="number" name="" defaultValue="8073589105" className="w-full dark:bg-transparent" />
            </InputContent>
          </div>
          ...
          <InputContent title={"Add tags"} className={"mt-4 w-full  cursor-pointer"}>
              <MultiselectDropdown
                options={[
                  {
                    cat: "tag 1",
            ...
            <div className=" py-[18px] flex justify-end items-center">
              <Button
                color="green"
                name={"Save"}
                className={"!text-sm !px-4"}></Button>
            </div>
          </div>
        </div>
        <div className="w-full md:max-w-[35%]">
          <div className="bg-primary-light dark:bg-white/5 rounded-2xl lg:pt-4 lg:pb-5 lg:px-6 sm:px-5 py-5 px-3 mb-[34px]">
            ...
            <div>
              ...
              <p className="my-[10] text-black/40 dark:text-white/40">Allowed file types: png, jpg, jpeg.</p>
            </div>
          </div>
          <div className="bg-primary-light dark:bg-white/5 rounded-2xl lg:pt-4 lg:pb-5 lg:px-6 sm:px-5 py-5 px-3 mb-[19px]">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-5">
          ...
          <div className="bg-primary-light dark:bg-white/5 rounded-2xl lg:pt-[21px] lg:pb-[19px] lg:pl-[23px] lg:pr-[15px] sm:px-5 py-5 px-3 mb-[19px]">
          ...
          <div className="bg-secondary-red/50 dark:bg-[#ffc7c7] rounded-2xl lg:pt-4 lg:pb-5 lg:px-6 sm:px-5 py-5 px-3">
            <div className="flex items-center justify-between mb-2.5 flex-wrap gap-5">
            ...
            <div>
              <p className="text-black/80">Not active.</p>
            </div>
          </div>
        </div>
      </div>
