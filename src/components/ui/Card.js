  ...
  return (
    <>
      <div className={`${className} md:px-3 w-full max-w-[456px] mx-auto md:mt-16 mt-5`}>
        <div className="rounded-2xl bg-primary-light dark:bg-white/5 px-4 py-3 pr-2 relative">
          <div className="transition-all duration-300 overflow-hidden h-auto opacity-100">
            <div className="flex mt-4 sm:gap-7 gap-5 sm:flex-row flex-col">
              <Image src={cardImage} alt="" className="sm:max-w-full  block max-w-[60%] mx-auto dark:invert" />
              <div className="mt-[19px]">
                <h3 className="font-semibold mb-[6px]">{title}</h3>
                <p className="text-xs sm:max-w-[169px] w-full">{discription}</p>
