...
const Toggle = ({ turnOff, turnOn, blueToggle }) => {
        ...
        <div className="flex items-center">
          <Switch
            ...
            className={classNames(
              enabled ? "bg-blue-1 dark:bg-blue-1" : "bg-black/20 dark:bg-white/20",
          ...
          >
            ...
            <span
              aria-hidden="true"
              className={classNames(
                enabled ? "translate-x-5 dark:bg-white" : "translate-x-0 dark:bg-blacklight",
