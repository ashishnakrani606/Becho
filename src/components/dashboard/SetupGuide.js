          ...
          <Image src={AddBrandAssets} alt="" className="mx-auto"/>
            <div className='mt-[19px] sm:pl-6'>
              ...
              <div className='mt-3 flex' >
                <Button color="yellow" name={'Add brand assets'} size={"small"} className="!text-xs font-semibold text-blacklight" onClick={brandassetsHandler} /> 
              </div>
          ...
          <div className={'flex mt-4 pl-2 sm:flex-row flex-col'}>
            ...
            <div className='mt-[19px] sm:pl-6'>
              ...
              <div className='mt-3 flex item-center'>
                <Button color="yellow" name={"Add product"} size={"small"} className="!text-xs font-semibold" onClick={firstProductHandler} />
                <Button color="grey" name={'Import'} size={"small"} className="!text-xs font-semibold ml-5" />
              </div>
              <Image className={`absolute right-4 bottom-3 opacity-10 dark:opacity-10 `} src={Subtract} alt="" />
            </div>  
          </div>
        ...
        <SetupGuideBox 
          ...
          <div className={'flex mt-4 pl-2 sm:flex-row flex-col'}>
            ...
            <div className='mt-[19px] sm:pl-6'>
              ...
              <div className='mt-3 flex '>
                <Button color="yellow" name={"Add domain"} size={"small"} secondary={"true"} className="!text-xs font-semibold text-blacklight" onClick={AddDomainHandler} /> 
              </div>
              <Image className={`absolute right-4 bottom-3 opacity-10 dark:opacity-10`} src={Subtract} alt="" />
            </div>  
          </div>
